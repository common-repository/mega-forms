...
if (!defined('MEGAFORMS_LOAD_COMBINED_CSS')) {
	define('MEGAFORMS_LOAD_COMBINED_CSS', true);
}

if (!defined('MEGAFORMS_LOAD_COMBINED_JS')) {
	define('MEGAFORMS_LOAD_COMBINED_JS', true);
}
...
add_action('plugins_loaded', 'update_Mega_Forms');
