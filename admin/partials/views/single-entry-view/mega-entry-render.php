...
class MegaForms_Entry_Render
{
        ...
        <tbody>
			...
			if (!empty($fields)) {
				foreach ($fields as $field) {
					...
					$unformatted_value = '';
					if (isset($this->entry->meta[$fieldID]) && !empty($this->entry->meta[$fieldID])) {
    ...
    <div id="mf_entry_sidebar" class="mf-entry-accordions mf_hidden">
        ...
        <div class="mf-entry-notes-list">
			...
			?>
            <span class="<?php echo $no_notes_class; ?>"><?php _e('You haven\'t added notes!'); ?></span>
        </div>
