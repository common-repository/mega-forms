...
class MegaForms_textarea extends MF_Field
{
	...
	public function is_spam($value)
	{
		...
		$patterns = array(
			'gay|sexy|porn|bdsm',
			'50% off|money back guarantee|get it now|buy here|buy now|act now|make dollars|earn ([\S]+) money|earn money online|purchase amazing|buy amazing|luxurybrandsale|beginning from just|take a look here',
