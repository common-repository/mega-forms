...
class Mega_Forms_Pro
{
	...
	private function define_common_hooks()
	{
		...
		// Customize a form's data object as soon as it's pulled from the database ( fields, field_types, containers, actions, settings )
		$this->loader->add_filter('mf_get_form', $pro_common, 'modify_get_form_data');
