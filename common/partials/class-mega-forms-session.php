...
class MF_Session
{
	...
	public function init_session_cookie()
	{
		...
		if ($cookie) {
			$this->_cookie_value       = implode('||', $cookie);
			...
			// Prepare cookie and session data. Actual cookie will be set via `init` hook.
			$this->set_session_expiration();
	 ...
	 */
	public function get_cookie_key()
	{
		return $this->_cookie;
	}
	/**
	...
	public function set_session_cookie()
	{
		...
		if (!isset($_COOKIE[$this->_cookie]) || $_COOKIE[$this->_cookie] !== $cookie_value) {
			$this->_cookie_value = $cookie_value;
			$this->setcookie($this->_cookie, $this->_cookie_value, $this->_session_expiration, $this->use_secure_cookie(), false);
		}
	}
