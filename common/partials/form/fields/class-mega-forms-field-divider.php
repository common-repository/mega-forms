...
class MegaForms_Divider extends MF_Field
{
	...
	protected function divider_options()
	{
		...
		$divider_options .= '<tr>';
		$divider_options .= '<td>';
		$divider_options .= get_mf_input(
            'number',
            array(
				'name'         => sprintf('%s[height]', $args['id']),
				'value'        => $height,
				' data-style'  => 'height',
				'data-preview' => $update_styles,
            )
        );
		...
		$divider_options .= get_mf_input(
            'number',
            array(
				'name'         => sprintf('%s[margin-top]', $args['id']),
				'value'        => $marginTop,
				' min'         => '20',
		...
		$divider_options .= get_mf_input(
            'number',
            array(
				'name'         => sprintf('%s[margin-bottom]', $args['id']),
				'value'        => $marginBottom,
				' min'         => '20',
